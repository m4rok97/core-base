 ...
 * @author César Pomar
 */
public class Marathon implements IScheduler {

    public static final String NAME = "marathon";

    private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(Marathon.class);
