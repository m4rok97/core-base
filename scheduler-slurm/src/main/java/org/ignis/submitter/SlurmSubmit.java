...
import org.ignis.scheduler.Slurm;
...
public class SlurmSubmit implements Callable<Integer> {
    ...
    private IContainerInfo parse(IProperties props, boolean driver) throws Exception {
        ...
        builder.swappiness(props.contains(driver ? IKeys.DRIVER_SWAPPINESS : IKeys.EXECUTOR_SWAPPINESS) ? props.getInteger(driver ? IKeys.DRIVER_SWAPPINESS : IKeys.EXECUTOR_SWAPPINESS) : null);
