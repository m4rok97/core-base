 ...
 * @author César Pomar
 */
public class ICountByKeyTask extends IDriverTask {
    ...
    public void run(ITaskContext context) throws IgnisException {
        LOGGER.info(log() + "countByKey started");
        try {
            executor.getMathModule().countByKey();
        ...
        LOGGER.info(log() + "countByKey finished");
    }
