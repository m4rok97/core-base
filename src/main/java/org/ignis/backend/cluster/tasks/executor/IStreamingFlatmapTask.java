 ...
 * @author César Pomar
 */
public final class IStreamingFlatmapTask extends IExecutorContextTask {
    ...
    public IStreamingFlatmapTask(IHelper helper, IExecutor executor, ISource function, boolean ordered) {
